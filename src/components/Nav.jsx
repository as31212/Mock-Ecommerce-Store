    ...
    return(
        ...
        <header>
            ...
            <div id="nav-button-container">
                ...
                <i onClick={()=> handleClick('/Cart')} className={`fa-solid fa-cart-shopping cart-icon ${location.pathname === '/Cart' ? 'full' : ''}`}><span className='item-count'>{Number(cart.reduce((acc,el)=> acc + Number(el.quantity),0)).toFixed(0)}</span></i>
